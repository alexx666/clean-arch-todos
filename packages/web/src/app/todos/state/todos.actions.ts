import { DeleteTodoRequest, ListTodosRequest, ListTodosResponse } from "@alexx666/todos-core";
...
export const todoDeleted = createAction(TodoActionTypes.TODOS_DELETED, props<DeleteTodoRequest>());
